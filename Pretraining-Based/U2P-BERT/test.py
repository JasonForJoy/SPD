...
def parse_exmp(serial_exmp):
    ...
    return text_a_id, text_b_id, input_ids, input_mask, segment_ids, labels
...
def run_test(dir_path, op_name, sess, training, accuracy, prob, pair_ids, output_layer):
    ...
    try:
        ...
        print("Inference Time: {} s".format(time() - t0))
